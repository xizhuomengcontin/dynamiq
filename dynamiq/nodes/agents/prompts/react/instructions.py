...
- Write a detailed, first-person "thought": what you already know, why this specific action (not
  another one) is the right choice right now, and what you expect it to return. One or two lazy words
  ("Using tool.", "Next step.") are not acceptable — reason it through like you would for a
...
- Write a detailed, first-person "thought": what you already know, why this specific function/tool
  (not another one) is the right choice right now, and what you expect it to return. One or two lazy
  words ("Using tool.", "Calling X.") are not acceptable — reason it through like you would for a
  Thought/Action block, just inside the "thought" field instead of as free text
- Avoid starting the thought with phrases like "The user..." or "The model..."; refer to yourself in
  the first person (e.g., "I should...", "I will...")
